    ...
    var lang = {
        ...
        hitch: function (scope, method) {
            ...
            if (arguments.length > 2) {
                return lang._hitchArgs.apply(window, arguments); // Function
            }
            if (!method) {
                method = scope;
                scope = null;
        ...
        partial: function (/*Function|String*/ method /*, ...*/) {
            ...
            var arr = [null];
            return lang.hitch.apply(window, arr.concat(lang._toArray(arguments))); // Function
        },
